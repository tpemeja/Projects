...
/* affecter une priorité à un thread entre 1 et 99
 * 1 est la priorité min
 * 99 est la priorité max
 * renvoie 0 en cas de succès, -1 en cas d'erreur
 */
...
typedef struct thread_mutex { int available;
 thread_t owner;} thread_mutex_t;
...
#define thread_setschedprio pthread_setschedprio
