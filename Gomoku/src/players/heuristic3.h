...
struct heuristic{
  ...
  int nb_layers;
  /**
   * cursor in order to have access to the stack
   */
  int cursor;
  /**
   * stack of good moves
   */
  struct move_t stack[H_STACK];
  /**
...
/**
 * @brief Extract the best moves from the matrix of opportunities and matrix of dangers (with the maximum evaluation) and push the best moves for the player that are better for us (opportunities) than for the opponent (dangers) on the stack
 * @param[in] h heuristic where matrix opportunities and dangers are checked
 * @param[in] color id of the player
 * @return push best moves for the player that are better for us (opportunities) than for the opponent (dangers) on the stack
 */
...
/**
 * @brief Get the last move of the stack and reduce the size of the stack
 * @param[in/out] h heuristic
 * @return last move_t of the stack
 */
